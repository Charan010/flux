...
public:
  ...
  virtual void write_global_header(BitWriter &bw, uint32_t orig_size, uint32_t num_chunks, uint32_t chunk_size) = 0;
  virtual void read_global_header(const uint8_t *data, size_t size, uint32_t &orig_size, uint32_t &num_chunks, 
